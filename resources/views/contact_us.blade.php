    ...
    <div class="flex md:flex-row flex-col justify-between max-w-screen-xl md:px-16 px-8 mx-auto gap-12 ">
        ...
        <div class="grid mx-auto text-center gap-4 ">
            <div>
                ...
                <p class="text-sm font-light text-gray-700 font-car">Location: Bahadurgarh, Haryana</p>
            </div>
            <div>
                <div class="w-20 p-6 mx-auto mb-3 bg-gray-200 rounded-md ">
                    <svg id="o" xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">
                ...
                <p class="text-sm font-light text-gray-700 font-car">SHOP NO -4, BAHADURGARH, Jhajjar, Haryana</p>
                <p class="text-sm font-light text-gray-700 font-car">Zip Code/Postal code:124507</p>
            </div>
            <div>
                <div class="w-20 p-6 mx-auto mb-3 bg-gray-200 rounded-md ">
                    <svg id="o" xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">
