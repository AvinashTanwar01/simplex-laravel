        ...
        <div class="bg-sec-100 ">
            ...
            <div class="flex justify-center md:py-28 py-12 mx-auto max-w-screen-xl">
                <div class="flex  flex-col justify-center md:w-3/5  mx-12 md:ms-20 md:mx-0">
                    <h1 class=" md:text-start text-center  font-car font-bold text-gray-900 mb-8  md:text-7xl text-4xl "><span class="text-pr-400"> EASY
                        ...
                        FAST WAY TO RENT YOUR TRUCKS</h1>
                    <div class="md:w-3/5 md:hidden  ">
                        <img loading="lazy" src="/images/HomeTruck.jpg
                        " alt="home car">
                    </div>
                    <p class="text-justify md:mx-0 mx-8 ">Whether you're transporting goods across town or embarking on a long-haul journey, we've got the perfect truck for you.
                    With our extensive fleet of cargo trucks and easy-to-use booking system, renting a truck has never been more convenient.</p>
                    <div class="flex justify-center md:justify-start mt-12 md:w-2/3 me-12 md:-ms-12">
                        <a href="/cars">
                            <button
                                class="bg-pr-400 p-2 border-2 border-white rounded-md text-white hover:bg-pr-500 w-32 md:me-12 md:mx-12 mx-7 font-bold ">Trucks</button>
                        </a>
                        <a href="/contact_us">
                ...
                <div class="md:w-3/5 hidden md:block  ">
                    <img loading="lazy" src="/images/Truck.webp
                    " alt="home car" >
                </div>
            ...
            <div class="mx-auto max-w-screen-xl">
                <div class="flex align-middle justify-center">
                    ...
                    <p class="my-2 mx-8  p-2 font-car font-bold text-pr-400 text-lg ">Trucks</p>
                    <hr class=" mt-8 h-0.5 w-2/5 bg-pr-500">
                    <hr>
                </div>
            ...
            <div class="mx-auto max-w-screen-xl ">
                ...
                <div class="mt-7 mb-16">
                    <p class="md:text-center text-xl text-justify mx-8 ">We prioritize your satisfaction and are committed to making your truck rental experience as smooth as possible. With our wide selection of well-maintained cargo trucks, competitive pricing, and simple booking process, you can rely on us to meet your needs. Our dedicated customer service team is available 24/7 to assist you, ensuring you get the support you deserve. Whether you're moving goods across town or heading out on a cross-country haul, choose us for a hassle-free and efficient trucking experience.</p>
                </div>
                ...
                <div
                    ...
                    <div class="flex justify-center align-middle ">
                        ...
                        <div>
                            <h3 class="font-car font-bold text-gray-900 text-2xl">Trucks</h3>
                            <p class="font-car text-gray-700 text-sm "> Experience the thrill of driving our top-of-the-line
                                Trucks that are sure to leave a lasting impression.</p>
                        </div>
                    </div>
                    <div class="flex justify-center align-middle ">
                        <div class="bg-gray-800 p-3 rounded-lg mx-3 mb-6 mt-2">
                    ...
                    <div class="flex justify-center align-middle ">
                        ...
                        <div>
                            ...
                            <p class="font-car text-gray-700 text-sm ">We guarantee the best prices for our rental Trucks,
                    ...
                    <div class="flex justify-center align-middle ">
                        ...
                        <div>
                            ...
                            <p class="font-car text-gray-700 text-sm ">Our streamlined process makes renting a truck quick
                    ...
                    <div class="flex justify-center align-middle ">
                        ...
                        <div>
                            ...
                            <p class="font-car text-gray-700 text-sm ">Take advantage of our convenient digital services,
                                making your truck rental experience even more convenient and efficient.
                            </p>
                        </div>
                    </div>
